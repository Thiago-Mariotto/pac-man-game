...
public class ScoreManager : MonoBehaviour {
    ...
    private string TopScoresURL = "http://localhost:3000/";
    ...
    void OnLevelWasLoaded(int level)
    {
        ...
        // if (level == 1) _lowestHigh = _highscore = 1254;
    ...
    //     HttpWebRequest request = (HttpWebRequest)WebRequest.Create(String.Format("http://localhost:3000/"));
    //     HttpWebResponse response = (HttpWebResponse)request.GetResponse();
    //     StreamReader reader = new StreamReader(response.GetResponseStream());
    //     string jsonResponse = reader.ReadToEnd();
    //     Debug.Log(jsonResponse);
        
    //     // _highscore = Int32.Parse(jsonResponse); 
